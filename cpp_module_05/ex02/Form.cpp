...
{
	if (this->getGradeExecuted() < bureaucrat.getGrade())
		throw Form::GradeTooLowException();
	else if (this->getBool() == 0)
...
{
	return ("Form is not signed and therefore cannot be executed");
}
