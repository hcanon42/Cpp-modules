...
int		main()
{
	...
	try
	{
		...
		std::cout << formc << std::endl << std::endl;
	}
	catch (std::exception &e)
	{
		std::cout << "ERROR: " << e.what() << std::endl << std::endl;
	}
	std::cout << "-----------------VALUING INTERN WORK------------------LOL" << std::endl << std::endl;
	try
	{
		Form		*forma;
		Form		*formb;
		Intern		intern;
		std::cout << "An intern has been recruited !" << std::endl << std::endl;

		std::cout << "Trying to make a shrubbery form..." << std::endl;
		forma = intern.makeForm("shrubbery form", "house");
		std::cout << "A form just got made ! --> " << forma->getName() << std::endl << std::endl;

		Bureaucrat	marc(4);
		std::cout << "A bureaucrat just got created ! --> " << marc << std::endl;
		marc.signForm(*forma);
		std::cout << std::endl << marc.getName() << " is trying to execute " << forma->getName() << "..." << std::endl;
		marc.executeForm(*forma);
		...
		std::cout << std::endl << "Trying to make a impossible form..." << std::endl;
		formb = intern.makeForm("Segfault form", "target");
		std::cout << "A form just got made ! --> " << formb->getName() << std::endl << std::endl;
